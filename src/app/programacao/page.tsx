...
import { ProgramacaoView } from '@/components/cinema/ProgramacaoView';
    ...
    return (
      <main className="mx-auto max-w-container-max px-margin-mobile py-stack-lg pb-24 md:pb-8">
        ...
        <p className="mt-2 text-body-md text-on-surface-variant">
          Confira os horários dos próximos 7 dias na tela 2D.
        </p>

        <ProgramacaoView filmes={filmes} sessoes={sessoes} />
      </main>
    );
  } catch (error) {
    return (
